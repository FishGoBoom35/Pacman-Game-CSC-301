...
Original PacMan code from https://github.com/Teanlouise/Pacman-Game, essentially all of the code from this project is theirs, outside of the above mentioned at the bottom of the readme.

We used whatever resources we could, that being ChatGPT, GeeksForGeeks, StackOverFlow, etc. and whatever else we could find that would help, including the core game mechanics of pacman using online resources and just playing the game.

Inspiration for PacMan and the algorithms used
